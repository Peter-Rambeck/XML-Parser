...
def parse_zone_resultforallprofitableproposals(etree, content, serial_id, logging, esi, cur, conn):

    for et in etree:
        zone_result_resultforallprofitableproposals_dict = {}
        zone_result_resultforallprofitableproposals_dict["EnergyLabelClassification"] = None
        zone_result_resultforallprofitableproposals_dict["xml_id_ref"] = serial_id

        dict_local = generic_extracting(etree, zone_result_resultforallprofitableproposals_dict)
        generate_sql_insert("zone_result_resultforallprofitableproposals", dict_local, content, logging, esi, cur, conn, 'null')
...
#                         if key1 == 'ResultForAllProfitableProposals':
#                             print('Now Im here 5')
