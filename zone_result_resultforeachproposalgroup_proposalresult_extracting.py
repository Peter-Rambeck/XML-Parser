...
def parse_zone_result_resultforeachproposalgroup_proposalresult(etree, logging, serial_id, content, esi, cur, conn):

    result_resultforeachproposalgroup_proposalresult_dict = {}
    # status_fuelconsumption_dict['FuelConsumption'] = {'Fuel': {'Material': None, 'Unit': None, 'EnergyPerUnit' : None, 'CO2PerUnit': None}, 
    # 'FuelPrice': {'CostPerUnit': None, 'FixedCostPerYear': None}, 'FuelConsumption': None, 'IsForHeating' : None}
    result_resultforeachproposalgroup_proposalresult_dict['Profitability'] = None 
    result_resultforeachproposalgroup_proposalresult_dict['Category'] = None 
    result_resultforeachproposalgroup_proposalresult_dict['Investment'] = None
    result_resultforeachproposalgroup_proposalresult_dict['FuelSavings'] = None 
    result_resultforeachproposalgroup_proposalresult_dict['zone_result_resultsforeachproposalgroup_id_ref'] = serial_id


    dict_local = generic_extracting(etree, result_resultforeachproposalgroup_proposalresult_dict)
    generate_sql_insert("resultforeachproposalgroup_proposalresult", dict_local, content, logging, esi, cur, conn, 'id')
