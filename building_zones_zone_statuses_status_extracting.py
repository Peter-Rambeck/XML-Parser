...
def parse_building_zones_zone_statuses_status(etree, content, zones_zone_id_ref, logging, esi, cur, conn, id_func):
    print("Status id_func: ", id_func)
    for id_ref in id_func:
        ...
        generate_sql_insert("statuses_status", dict_local, content, logging, esi, cur, conn, 'null')
