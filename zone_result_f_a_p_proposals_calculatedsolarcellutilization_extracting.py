...
def parse_result_f_a_p_proposals_calculatedsolarcellutilization(etree, content, serial_id, logging, esi, cur, conn):

    for et in etree:
        result_f_a_p_proposals_calculatedsolarcellutilization_dict = {}
        result_f_a_p_proposals_calculatedsolarcellutilization_dict["SolarCellShare"] = None
        result_f_a_p_proposals_calculatedsolarcellutilization_dict["TotalUtilizationPercent"] = None
        result_f_a_p_proposals_calculatedsolarcellutilization_dict["zone_result_resultforallprofitableproposals_id_ref"] = serial_id        
        
        dict_local = generic_extracting(etree, result_f_a_p_proposals_calculatedsolarcellutilization_dict)
        generate_sql_insert("result_f_a_p_proposals_calculatedsolarcellutilization", dict_local, content, logging, esi, cur, conn, 'id')
