...
def parse_zone_result_resultforallproposals(etree, content, serial_id, logging, esi, cur, conn):

    for et in etree:
        zone_result_resultforallproposals_dict = {}
        zone_result_resultforallproposals_dict["EnergyLabelClassification"] = None
        zone_result_resultforallproposals_dict["xml_id_ref"] = serial_id

        dict_local = generic_extracting(etree, zone_result_resultforallproposals_dict)
        generate_sql_insert("zone_result_resultforallproposals", dict_local, content, logging, esi, cur, conn, 'null')
