...
def parse_zone_result_status_calculatedbe10result_keyfigures(etree, content, serial_id, logging, esi, cur, conn):

    #print(etree.tag)

    status_calculatedbe10result_keyfigures_dict = {}

    status_calculatedbe10result_keyfigures_dict["TransmissionLossThroughEnvelopeExcludingWindowsAndDoors"] = None
    status_calculatedbe10result_keyfigures_dict["EnergyFrame2010"] = {"EnergyFrameInBRNoAddition": None, 
    ...
    status_calculatedbe10result_keyfigures_dict["EnergyFrame2015"] = {"EnergyFrameInBRNoAddition" : None, "AdditionToEnergyFrameDueToSpecialConditions": None, 
    "TotalEnergyRequirement": None, "ContributionToEnergyRequirementHeating": None, "ContributionToEnergyRequirementElectricity": None, "ContributionToEnergyRequirementExcessTemprature": None }
    status_calculatedbe10result_keyfigures_dict["EnergyFrame2020"] = {"EnergyFrameInBRNoAddition": None, 
    ...
    status_calculatedbe10result_keyfigures_dict["zone_result_status_id_ref"] = serial_id


    dict_local = generic_extracting(etree, status_calculatedbe10result_keyfigures_dict)
        
    generate_sql_insert("status_calculatedbe10result_keyfigures", dict_local, content, logging, esi, cur, conn, 'id')
...
#                         if key1 == 'KeyFigures':
#                             print('Now Im here 5')
#                             parse_zone_result_status_calculatedbe10result_keyfigures(et, esi, serial_id, logging, cur, conn)
...
#     content_types = [{'ZoneResult': {'Status': {'CalculatedBe10Result': {'KeyFigures': None} }}}]  #[{'InputData':[{"Label": ["ProposalGroups"]}]}, {'ResultData': ["LabelResults", "BuildingResult"]}, 'Building']
...
#                         parse_zone_result_status_calculatedbe10result_keyfigures(etree, content, logging, esi, cur, conn)
