...
def parse_zone_result_status_calculatedbe15result_keyfigures(etree, content, serial_id, logging,  esi, cur, conn):

    #print(etree.tag)

    status_calculatedbe15result_keyfigures_dict = {}
   
    status_calculatedbe15result_keyfigures_dict["TransmissionLossThroughEnvelopeExcludingWindowsAndDoors"] = None

    status_calculatedbe15result_keyfigures_dict["RenovationClass2"] = {"EnergyFrameInBRNoAddition": None, "AdditionToEnergyFrameDueToSpecialConditions": None, 
    "TotalEnergyRequirement": None, "ContributionToEnergyRequirementHeating": None}

    status_calculatedbe15result_keyfigures_dict["RenovationClass1"] = {"EnergyFrameInBRNoAddition": None, 
    "AdditionToEnergyFrameDueToSpecialConditions": None, 
    "TotalEnergyRequirement": None, "ContributionToEnergyRequirementHeating": None}
   
    status_calculatedbe15result_keyfigures_dict["EnergyFrame2015"] = {"EnergyFrameInBRNoAddition" : None, "AdditionToEnergyFrameDueToSpecialConditions": None, 
    ...
    status_calculatedbe15result_keyfigures_dict["EnergyFrame2020"] = {"EnergyFrameInBRNoAddition": None, 
    ...
    status_calculatedbe15result_keyfigures_dict["zone_result_status_id_ref"] = serial_id

    dict_local = generic_extracting(etree, status_calculatedbe15result_keyfigures_dict)
    generate_sql_insert("status_calculatedbe15result_keyfigures", dict_local, content, logging, esi, cur, conn, 'id')
