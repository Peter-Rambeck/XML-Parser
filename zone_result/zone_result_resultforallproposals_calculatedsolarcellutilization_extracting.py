...
def parse_zone_result_resultforallproposals_calculatedsolarcellutilization(etree, content, serial_id, logging, esi, cur, conn):

    for et in etree:
        result_resultforallproposals_calculatedsolarcellutilization_dict = {}
        result_resultforallproposals_calculatedsolarcellutilization_dict["SolarCellShare"] = None
        result_resultforallproposals_calculatedsolarcellutilization_dict["TotalUtilizationPercent"] = None
        result_resultforallproposals_calculatedsolarcellutilization_dict["zone_result_resultforallproposals_id_ref"] = serial_id        
        
        dict_local = generic_extracting(etree, result_resultforallproposals_calculatedsolarcellutilization_dict)
        generate_sql_insert("resultforallproposals_calculatedsolarcellutilization", dict_local, content, logging, esi, cur, conn, 'id')
