...
def parse_zone_result_status_fuelconsumption(etree, logging, serial_id, content, esi, cur, conn):

    status_fuelconsumption_dict = {}
    ...
    status_fuelconsumption_dict['Fuel'] = {'Material': None, 'Unit': None, 'EnergyPerUnit' : None, 'CO2PerUnit': None} 
    status_fuelconsumption_dict['FuelPrice'] = {'CostPerUnit': None, 'FixedCostPerYear': None} 
    status_fuelconsumption_dict['FuelConsumption'] = None 
    status_fuelconsumption_dict['IsForHeating'] = None 
    status_fuelconsumption_dict['zone_result_status_id_ref'] = serial_id 

    dict_local = generic_extracting(etree, status_fuelconsumption_dict)
    generate_sql_insert("status_fuelconsumption", dict_local, content, logging, esi, cur, conn, 'id')
