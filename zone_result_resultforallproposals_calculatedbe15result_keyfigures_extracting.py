...
def parse_result_resultforallproposals_calculatedbe15result_keyfigures(etree, content, serial_id, logging,  esi, cur, conn):

    result_resultforallproposals_calculatedbe15result_keyfigures_dict = {}
   
    result_resultforallproposals_calculatedbe15result_keyfigures_dict["TransmissionLossThroughEnvelopeExcludingWindowsAndDoors"] = None

    result_resultforallproposals_calculatedbe15result_keyfigures_dict["RenovationClass2"] = {"EnergyFrameInBRNoAddition": None, "AdditionToEnergyFrameDueToSpecialConditions": None, 
    "TotalEnergyRequirement": None, "ContributionToEnergyRequirementHeating": None}

    result_resultforallproposals_calculatedbe15result_keyfigures_dict["RenovationClass1"] = {"EnergyFrameInBRNoAddition": None, 
    "AdditionToEnergyFrameDueToSpecialConditions": None, 
    "TotalEnergyRequirement": None, "ContributionToEnergyRequirementHeating": None}
   
    result_resultforallproposals_calculatedbe15result_keyfigures_dict["EnergyFrame2015"] = {"EnergyFrameInBRNoAddition" : None, "AdditionToEnergyFrameDueToSpecialConditions": None, 
    ...
    result_resultforallproposals_calculatedbe15result_keyfigures_dict["EnergyFrame2020"] = {"EnergyFrameInBRNoAddition": None, 
    ...
    result_resultforallproposals_calculatedbe15result_keyfigures_dict["zone_result_resultforallproposals_id_ref"] = serial_id

    dict_local = generic_extracting(etree, result_resultforallproposals_calculatedbe15result_keyfigures_dict)
    generate_sql_insert("resultforallproposals_calculatedbe15result_keyfigures", dict_local, content, logging, esi, cur, conn, 'id')
